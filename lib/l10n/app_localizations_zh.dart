...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get aboutDeveloperStory => '云和海分居两地，人和人相聚别离。一个在夏天停步，另一个在秋天打探消息。一个就是喜欢，另一个觉得麻烦。总会经历心甘情愿，我知道你不怕难，只是别睡太晚。';
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get aboutDeveloperStory => '雲和海分居兩地，人和人相聚別離。一個在夏天停步，另一個在秋天打探消息。一個就是喜歡，另一個覺得麻煩。總會經歷心甘情願，我知道你不怕難，只是別睡太晚。';
