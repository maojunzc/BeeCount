...
abstract class AppLocalizations {
  ...
  /// No description provided for @aboutQQ.
  ///
  /// In en, this message translates to:
  /// **'QQ'**
  String get aboutQQ;
  ...
  ///
  /// In en, this message translates to:
  /// **'Clouds and seas live apart, people meet and part. One pauses in summer, the other seeks news in autumn. One simply loves it, the other finds it a bother. We all go through willing surrender—I know you\'re not afraid of hardship, just don\'t stay up too late.'**
