...
不可接受的行为可以通过联系项目团队 2316562571@qq.com 来报告。所有投诉都将被审查和调查，并将做出必要且适当的回应。

## 我能做什么贡献？

### 🐛 报告 Bug

发现了问题？请通过 [GitHub Issues](https://github.com/maojunzc/BeeCount/issues) 告诉我们。

### 💡 提出新功能

有好的想法？我们很乐意听到！请先查看 [Issues](https://github.com/maojunzc/BeeCount/issues) 和 [Discussions](https://github.com/maojunzc/BeeCount/discussions) 看看是否已经有人提出。
...
- GitHub Issues: [提交设计建议](https://github.com/maojunzc/BeeCount/issues)
- Email: 2316562571@qq.com
...
1. 检查 [FAQ](https://github.com/maojunzc/BeeCount/wiki/常见问题-FAQ) 看看问题是否已有解决方案
2. 搜索 [现有 Issues](https://github.com/maojunzc/BeeCount/issues) 确认问题未被报告
3. 确保你使用的是最新版本
...
1. 检查 [Discussions](https://github.com/maojunzc/BeeCount/discussions) 中的"Ideas"分类
...
```bash
git remote add upstream https://github.com/maojunzc/BeeCount.git
```
...
```bash
git clone https://github.com/maojunzc/BeeCount.git
cd BeeCount
```
...
- [GitHub Discussions](https://github.com/maojunzc/BeeCount/discussions) - 项目讨论
- [V2EX 帖子](https://www.v2ex.com/t/1168480) - 中文社区
- Email: 2316562571@qq.com - 直接联系
...
如有任何问题，欢迎通过 [Issues](https://github.com/maojunzc/BeeCount/issues) 或 [Discussions](https://github.com/maojunzc/BeeCount/discussions) 与我们联系。
